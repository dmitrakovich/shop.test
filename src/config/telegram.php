...
return [
    /**
     * Идентификатор чата в котрый будут отправляться ошибки
     */
    'chat_id_for_errors' => env('TELEGRAM_BOT_CHAT_ID_FOR_ERRORS', 0),
    /*
    |--------------------------------------------------------------------------
    | Your Telegram Bots
    |--------------------------------------------------------------------------
    ...
    */
    'bots'                         => [
        'mybot' => [
            ...
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://bellavka.ru/' . env('SECRET_PATH') . '/bot/tg'),
            'commands'            => [
                App\Http\Bots\Telegram\Commands\DdosCommand::class,
                App\Http\Bots\Telegram\Commands\GitPullCommand::class,
                App\Http\Bots\Telegram\Commands\UpdateCommandsListCommand::class,
                App\Http\Bots\Telegram\Commands\CurrenciesCommand::class,
                App\Http\Bots\Telegram\Commands\ShowMyIdCommand::class,
                App\Http\Bots\Telegram\Commands\HelpCommand::class,
                App\Http\Bots\Telegram\Commands\LastOrderCommand::class,
            ],
        ],
