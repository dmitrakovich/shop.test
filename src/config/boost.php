...
return [
    ...
    */
    ...
    'executable_paths' => [
        ...
        // Laravel app lives in src/; Cursor workspace root is the repo root.
        'sail' => env('BOOST_SAIL_EXECUTABLE_PATH', 'src/vendor/bin/sail'),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Cursor opens the repository root, not src/. Point Boost outputs at the
    | workspace-level .cursor directory and AGENTS.md in the repo root.
    |
    */
