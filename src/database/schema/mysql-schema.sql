...
CREATE TABLE `banners` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `position` enum('catalog_main','feedback_main','index_main','index_pair','index_bottom','main_menu_catalog') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
