...
Schedule::job(new \App\Jobs\Mailing\SendingTracksJob())->dailyAt('18:20');
...
Schedule::command('seo-page-stats:update')->withoutOverlapping()->dailyAt('05:30');
...
Schedule::command('sms:update-statuses')->withoutOverlapping()->everyTenMinutes();
