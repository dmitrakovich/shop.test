    ...
    private function getPaymentMethodServiceByEnum(OnlinePaymentMethodEnum $paymentMethodEnum)
    {
        switch ($paymentMethodEnum) {
            case OnlinePaymentMethodEnum::ERIP:
                return $this->paymentMethodService[OnlinePaymentMethodEnum::ERIP->value] ??= new PaymentEripService();
                break;
            case OnlinePaymentMethodEnum::YANDEX:
                return $this->paymentMethodService[OnlinePaymentMethodEnum::YANDEX->value] ??= new PaymentYandexService();
                break;
            case OnlinePaymentMethodEnum::COD:
                return $this->paymentMethodService[OnlinePaymentMethodEnum::COD->value] ??= new PaymentCODService();
                break;
        }
    }
