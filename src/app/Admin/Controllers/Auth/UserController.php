...
class UserController extends AdminController
{
    ...
    public function form()
    {
        ...
        $isDirector = Admin::user()->isRole('director');
        ...
        if ($isAdmin || $isDirector) {
            $form->multipleSelect('roles', trans('admin.roles'))->options($roleModel::all()->pluck('name', 'id'))->default(2);
            $form->multipleSelect('permissions', trans('admin.permissions'))->options($permissionModel::all()->pluck('name', 'id'));
        } else {
            $form->multipleSelect('roles', trans('admin.roles'))->options($roleModel::all()->pluck('name', 'id'))->default(2)->readonly();
            $form->multipleSelect('permissions', trans('admin.permissions'))->options($permissionModel::all()->pluck('name', 'id'))->readonly();
        }
