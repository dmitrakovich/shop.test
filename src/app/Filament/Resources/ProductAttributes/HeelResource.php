...
use App\Filament\Resources\ProductAttributes\Pages\CreateHeel;
use App\Filament\Resources\ProductAttributes\Pages\EditHeel;
use App\Filament\Resources\ProductAttributes\Pages\ListHeels;
use App\Models\Heel;
...
class HeelResource extends Resource
{
    ...
    {
        return [
            'index' => ListHeels::route('/'),
            'create' => CreateHeel::route('/create'),
            'edit' => EditHeel::route('/{record}/edit'),
        ];
    }
}
