...
@section('content')
    ...
    <div class="row wrapper justify-content-center">
        ...
        <div class="col-12 text-justify my-5">
            ...
            <br><br><br>
            Номер контактного телефона и адрес электронной почты  лица, уполномоченного продавцом рассматривать обращения покупателей о нарушении их прав, предусмотренных законодательством о защите прав потребителей<br>
            +375 29 522-77-22,  info@barocco.by
            <br>
            Номер контактного телефона работников Брестского городского исполнительного комитета, уполномоченных рассматривать обращения покупателей в соответствии с законодательством об обращениях граждан и юридических лиц<br>
            +375 162 21-04-75
        </div>
    @endsection
