...
@section('content')
    ...
    <div class="p-index">
            ...
            <div class="p-index__about">
                ...
                <div class="p-index__about-info">
                    <div class="p-index__about-text">
                        <p>
                            В нашем каталоге – обувь и аксессуары в рассрочку с доставкой по Минску и Беларуси. Уже не
                            первый
                            год мы
                            привозим в Беларусь продукцию VITACCI.
                        </p>
                        <p>
                            Если вы знакомы не понаслышке с дизайнерской обувью, то хорошо помните то ощущение легкости,
                            невесомости
        ...
        <div class="p-index__text col-12">
            ...
            <p class="mb-4">Обувь BAROCCO идеальна в носке и подойдёт каждому, так как она подобрана с учетом
                особенностей строения женской ступни.</p>
            <p class="mb-4">Также BAROCCO.BY является официальным поставщиком именитых обувных брендов VITACCI, Basconi,
