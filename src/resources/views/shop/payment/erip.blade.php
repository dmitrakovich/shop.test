    ...
    <h2 class="h3 mb-3 text-center font-weight-normal">Как оплатить?</h3>
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <p>Оплатить можно через мобильный и интернет-банкинг, банкомат и инфокиоск, в отделении банка или почты.</p>
                <p><b>Порядок оплаты</b></p>
                <p>1. Выберите пункт <i>Система "Расчёт" (ЕРИП)</i>.</p>
                <p>2. Перейдите в <i>Сервис E-POS</i> (второй в списке).</p>
                <p>3. Введите номер счета <b><i>{{ config('hgrosh.serviceproviderid') }}-1-{{ $online_payment->payment_num }}</i></b>.</p>
