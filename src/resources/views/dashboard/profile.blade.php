...
<div class="col-12 col-lg-9 static-page">
    ...
    <form method="post" action="{{ route('dashboard-profile-update', $user) }}" class="mt-4">
        ...
        <div class="form-group row">
            <label for="email" class="d-none d-md-block col-md-4 col-xl-3 col-form-label">Ваш e-mail</label>
        ...
        <div class="form-group row">
            <label for="password" class="d-none d-md-block col-md-4 col-xl-3 col-form-label">Пароль</label>
            <div class="col-12 col-md-8 col-lg-4 col-xl-3">
        ...
        <div class="form-group row">
            <label for="phone" class="d-none d-md-block col-md-4 col-xl-3 col-form-label">Телефон</label>
            <div class="col-12 col-md-8 col-lg-4 col-xl-3">
        ...
        <div class="form-group row">
            <label for="birth_date" class="d-none d-md-block col-md-4 col-xl-3 col-form-label">Дата рождения</label>
            <div class="col-12 col-md-8 col-lg-4 col-xl-3">
