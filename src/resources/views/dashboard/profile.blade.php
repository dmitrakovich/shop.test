...
<div class="col-12 col-lg-9 static-page">
    ...
    <form method="post" action="{{ route('dashboard-profile-update', $user) }}" class="mt-4">
        ...
        <div class="form-group row">
            <label for="phone" class="d-none d-md-block col-md-3 col-form-label">Телефон</label>
            <div class="col-12 col-md-3">
                <input id="phone" type="tel" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="+375">
                @error('phone')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
