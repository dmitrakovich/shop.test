                ...
                <div class="col-md-10">
                    <div class="@if ($lastAddress->approve) bg-success @else bg-danger @endif"
                        ...
                        @php
                            ...
                            $resultAddress[] = $lastAddress->getAddressRow();
                        @endphp
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                        <input type="text" name="addressDistrict" class="form-control"
                                            value="{{ $lastAddress->district }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button"
                                class="btn btn-primary js-updateOrderUserAddress">Сохранить</button>
                        </div>
                    </div>
                </div>
            </div>
