...
| Catalog/search | [Elasticsearch faceted catalog](elasticsearch-faceted-catalog.md) | Plan: ES read model for storefront search/filters (no Scout), sync, phases, parity with CatalogService. |
